    ...
    function viewWithSlash($res)
    {
        ...
        while ($dsatz = mysqli_fetch_assoc($res))
        {
            ...
            echo "<tr class='timeRow'>"
                ."<td></td>"
                ."<td colspan='3' class='columnDateTime'>" . (date('d.m.Y H:i', strtotime($dsatz['create']))) . " Uhr - erstellt von: " . $dsatz['user'] . " / " . (date('d.m.Y H:i', strtotime($dsatz['date']))) . " Uhr - geändert von: " . $dsatz['updateBy'] . testFunction() . "</td>"
